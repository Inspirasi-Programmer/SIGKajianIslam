...
public class Config {
    //location server
    public static final String URL_GAMBAR = "http://192.168.1.72/SIGKajianIslam2/";
    public static final String URL_SERVER = "http://192.168.1.72/SIGKajianIslam2/MobileKajianIslam/";
